...
| :--- | :--- | :--- | :--- | :--- |
| Field | Nova Anomalia | Botão escondido dentro de 3 menus | Colocar na Sticky Bar da OS | Backlog |
| Sales | Criar Proposta | Modal bloqueia visão do histórico | Mudar para Slide-over | Backlog |
| Owner | Home | Tabela de OS desnecessária na home | Remover tabela, deixar só KPIs | Backlog |
