...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Orçamentos (Lista)** | Indisponível no Dock | ∞ | Não | Não encontraria | 🔴 VERMELHO |
...
* **Omissão de Fluxo Comercial:** O perfil SOLO possui atalhos para *criar* orçamentos, mas a interface removeu o acesso à aba `budgets` do Dock principal. Isso impede que o operador gerencie o pipeline de vendas ou consulte propostas enviadas.
