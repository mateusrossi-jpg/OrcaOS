...
- Name: visualAudit.spec.ts >> Mobile Structural Layout Audit >> Home screen structural integrity
- Location: tests/e2e/visualAudit.spec.ts:27:3
...
Call log:
  - waiting for locator('.operational-metrics-panel')
...
- main [ref=e3]:
  ...
  - main [ref=e14]:
    ...
    - generic [ref=e18]:
      ...
      - generic [ref=e22]:
        - generic [ref=e23]: 🚀
        - strong [ref=e24]: Sua operação começa aqui
        - generic [ref=e25]: Crie seu primeiro orçamento para começar a gerenciar seus ganhos com precisão.
        - button "Criar primeiro orçamento" [ref=e27] [cursor=pointer]
  - navigation [ref=e28]:
    - button "Resumo" [ref=e29] [cursor=pointer]:
      - img [ref=e31]
      - generic [ref=e33]: Resumo
    - button "Operação" [ref=e34] [cursor=pointer]:
      - img [ref=e36]
      - generic [ref=e38]: Operação
    - button "Financeiro" [ref=e39] [cursor=pointer]:
      - img [ref=e41]
      - generic [ref=e43]: Financeiro
    - button "Mais" [ref=e44] [cursor=pointer]:
      - img [ref=e46]
      - generic [ref=e48]: Mais
```
