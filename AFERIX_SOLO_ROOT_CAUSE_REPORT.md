...
* **Reduzir Complexidade:** O perfil SOLO removeu abas de gestão de equipe para limpar o Dock.
...
| :--- | :--- | :--- | :--- |
| **Orçamentos** | Conversão/Venda | **Oculto (Dock)** | Impede gestão do pipeline de faturamento. |
