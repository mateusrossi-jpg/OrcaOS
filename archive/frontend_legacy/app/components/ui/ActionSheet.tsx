...
export const ActionSheet = memo(function ActionSheet({
  ...
  return createPortal(
    ...
    >
      <div 
        className="bg-[#383F48] border-t border-white/[0.1] rounded-t-[var(--radius-modal)] w-full max-w-[430px] animate-in slide-in-from-bottom-full duration-500 cubic-bezier(0.16, 1, 0.3, 1) relative overflow-hidden shadow-[0_-12px_64px_rgba(0,0,0,1)]"
