...
export const StoreScreen = memo(function StoreScreen({ account, onBack }: StoreScreenProps) {
  ...
  return (
    <ScreenContainer className="pb-32 pt-0 px-0 PageShell">
      ...
      <div className="px-6 flex flex-col gap-6 plan-card-grid">
        ...
        <SurfaceCard variant="cinematic" padding="lg" className={cn("PlanCard", account.plan === 'pro' ? 'PRO' : 'FREE', "VITALÍCIO")}>
