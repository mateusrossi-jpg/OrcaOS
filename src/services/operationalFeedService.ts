...
const EVENT_TITLES: Record<string, string> = {
  ...
  SITE_CREATED: 'Unidade cadastrada',
  SITE_UPDATED: 'Unidade atualizada',
  ASSET_REGISTERED: 'Equipamento registrado',
  ASSET_UPDATED: 'Equipamento atualizado',
  WORKORDER_ASSET_LINKED: 'Vínculo técnico realizado',
  MAINTENANCE_PLAN_CREATED: 'Plano de preventiva criado',
  MAINTENANCE_PLAN_UPDATED: 'Plano de preventiva atualizado',
  PREVENTIVE_WORKORDER_GENERATED: 'Preventiva agendada',
  CONTRACT_CREATED: 'Contrato ativado',
  CONTRACT_UPDATED: 'Contrato atualizado',
  RECURRING_BILLING_GENERATED: 'Cobrança mensal gerada',
