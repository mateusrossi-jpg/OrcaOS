...
export const professionalModules: ProfessionalModule[] = [
...

  {
    ...
    description: 'Base de cálculo para eletricistas, técnicos e estudantes: Ohm, potência, corrente, resistores e consumo.',
    status: 'active',
    plan: 'freeBase',
    freeCalculatorTarget: 7,
  ...
  },
  {
    ...
    shortTitle: 'Motores',
    description: 'Cálculos para motores, corrente, rotação, escorregamento, torque, capacitor e transmissão.',
    status: 'active',
    plan: 'proModule',
    freeCalculatorTarget: 7,
    totalCalculatorTarget: 25,
  ...
  },
  {
    ...
    freeCalculatorTarget: 5,
    totalCalculatorTarget: 20,
    examples: ['Contator', 'Relé térmico', 'Fonte 24 V', 'Corrente de bobinas', 'Temporizadores', 'Estrela-triângulo', 'Comando de motor'],
  },
  {
  ...
  },
  {
    ...
    description: 'Especialização eletrotécnica para rebobinagem de motores, fechamento, ligação e sentido de rotação.',
    status: 'planned',
    plan: 'futurePackage',
    freeCalculatorTarget: 3,
    totalCalculatorTarget: 25,
...
export const professionalFamilies: ProfessionalFamily[] = [
  {
    ...
    description: 'Ferramentas que servem para todas as profissões e formam a base gratuita/comercial do OrçaOS.',
  ...
  },
  {
    ...
    description: 'Família profissional que agrupa elétrica, motores, comandos, automação, eletrônica aplicada, transformadores, rebobinagem e solar.',
