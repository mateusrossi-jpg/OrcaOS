...
export const calculationModules: ModuleCardData[] = [
  ...
  { id: 'eletricaResidencial', title: 'Elétrica residencial', description: 'Cabo, disjuntor, queda, eletroduto, cargas, fases, aterramento e DR/DPS', icon: 'ϟ', tone: 'green', count: '9 cálculos', available: true, plan: 'pro', calculatorModule: 'eletricaResidencial' },
  ...
  { id: 'construcaoAvancada', title: 'Construção avançada', description: 'Argamassas, concreto, revestimento, rodapé, telhado, escada e rampa', icon: '▧', tone: 'gray', count: '9 cálculos', available: true, plan: 'pro', calculatorModule: 'construcaoAvancada' },
  ...
  { id: 'hidraulicaAvancada', title: 'Hidráulica avançada', description: 'Caixa por pessoas, piscina, esgoto, pressão por coluna e bomba simples', icon: '≋', tone: 'green', count: '8 cálculos', available: true, plan: 'pro', calculatorModule: 'hidraulicaAvancada' },
  ...
  { id: 'conversoresAvancados', title: 'Conversores avançados', description: 'AWG, potência, térmica, pressão, vazão, polegadas, temperatura e kWh/R$', icon: '⇄', tone: 'green', count: '10 conversores', available: true, plan: 'free', calculatorModule: 'conversoresAvancados' },
  ...
  { id: 'financeiroAvancado', title: 'Financeiro avançado', description: 'Margem real, markup, desconto máximo, taxas, entrada, hora real e faixas', icon: 'R$', tone: 'orange', count: '9 cálculos', available: true, plan: 'pro', calculatorModule: 'financeiroAvancado' },
...
export const calculationSectorGroups: CalculationSectorGroup[] = [
  {
    ...
    icon: 'ϟ',
    moduleIds: ['fundamentos', 'eletricaResidencial', 'instalacoes', 'iluminacao', 'motores', 'automacaoIndustrial', 'transformadores', 'solar', 'eletronica', 'rebobinagem'],
  },
  {
    id: 'hydraulics',
    title: 'Hidráulica',
  ...
  },
  {
    ...
    icon: '▧',
    moduleIds: ['construcaoCivil', 'construcaoAvancada', 'medicoesObra'],
  },
  {
    id: 'painting',
  ...
  },
  {
    ...
    icon: 'R$',
    moduleIds: ['orcamentoTecnico', 'financeiroAvancado', 'percentuaisComerciais', 'custosProdutividade'],
  },
  {
    id: 'converters',
    title: 'Conversores e unidades',
    description: 'Conversões rápidas de unidades usadas em obra, manutenção e orçamento.',
    icon: '⇄',
...
export const storePackages = [
  { title: 'Base gratuita', description: 'Elétrica inicial, hidráulica, construção civil, pintura, conversores, medições e financeiro simples.', price: 'R$ 0', icon: '∑' },
