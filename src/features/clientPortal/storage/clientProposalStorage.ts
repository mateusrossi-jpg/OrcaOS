...
import type {
  ClientProposal,
  ClientProposalPublicItem,
  ClientProposalStatus,
  ClientPurchaseMaterialItem,
} from '../../../domain/clientProposal';

export type { ClientProposalStatus, ClientProposalPublicItem, ClientPurchaseMaterialItem, ClientProposal };
