...
export const starterGuidedLaborTemplates: GuidedLaborTemplate[] = [
  ...
  { id: 'ponto-rede', title: 'Ponto de infraestrutura técnica', defaultUnitValue: 95, unit: 'ponto', note: 'Instalação de ponto de infraestrutura, validar cabo, conector e teste.', visible: true, createdAt: STARTER_TIMESTAMP, updatedAt: STARTER_TIMESTAMP },
];
