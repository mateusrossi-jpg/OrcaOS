...
const rules: FundamentalRule[] = [
  ...
  { mode: 'ohms-law', label: 'Lei de Ohm', description: 'Escolha se quer calcular resistência, corrente ou tensão.', icon: 'Ω', example: 'Ex.: 220 V e 10 A indicam resistência aproximada de 22 Ω.', technicalNote: 'Lei de Ohm é direta para cargas resistivas; cargas eletrônicas e equipamentos técnicos e variações térmicas podem fugir desse comportamento.' },
    ...
    try {
      ...
      if (activeRule.mode === 'power-from-current') {
        ...
        return result(
          ...
          'Use para estimar potência de uma carga conhecida. Para cargas técnicas e cargas indutivas, ajuste o fator de potência em avançado.',
