...
const PanelCard = ({ children, className = '' }: { children: React.ReactNode; className?: string }) => (
  <div className={`bg-white/[0.02] border border-white/[0.05] p-5 rounded-[22px] ${className}`}>
    {children}
  </div>
);

const EmptyState = ({ title, description }: { title: string; description?: string }) => (
  <div className="w-full py-16 px-4 flex flex-col items-center justify-center text-center opacity-60">
