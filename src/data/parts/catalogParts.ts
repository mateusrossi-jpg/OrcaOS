...
export const catalogParts: CatalogPart[] = [
  {
    id: 'schneider-tomada-modulo-2pt-20a-branca',
    brand: 'Schneider',
    line: 'Linha modular',
    ...
    source: 'internal',
    estimatedPrice: 18.5,
    keywords: ['tomada', 'modulo', '2p+t', '20a', 'branca', 'schneider'],
  },
  {
    id: 'schneider-disjuntor-din-bipolar-32a',
    brand: 'Schneider',
    line: 'Acti9 / DIN',
    ...
    source: 'internal',
    estimatedPrice: 46.9,
    keywords: ['disjuntor', 'din', 'bipolar', '32a', 'curva c', 'schneider'],
  },
  {
    id: 'schneider-dps-classe-ii-275v',
    brand: 'Schneider',
    line: 'DIN',
    category: 'Proteção elétrica',
    subcategory: 'DPS',
    ...
    source: 'internal',
    estimatedPrice: 62.0,
    keywords: ['dps', 'surto', 'proteção', 'classe ii', '275v', 'schneider'],
  },
  {
    id: 'margirius-interruptor-paralelo-modulo-branco',
    brand: 'Margirius',
    line: 'Linha modular',
    ...
    source: 'internal',
    estimatedPrice: 12.9,
    keywords: ['interruptor', 'paralelo', 'modulo', 'branco', 'margirius'],
  },
  {
    id: 'margirius-tomada-modulo-2pt-10a-branca',
    brand: 'Margirius',
    line: 'Linha modular',
    category: 'Tomadas e módulos',
    subcategory: 'Tomada 2P+T',
    ...
    source: 'internal',
    estimatedPrice: 10.5,
    keywords: ['tomada', 'modulo', '2p+t', '10a', 'branca', 'margirius'],
  },
  {
    id: 'margirius-placa-4x2-dupla-branca',
    brand: 'Margirius',
    line: 'Linha modular',
    category: 'Acabamento',
    ...
    source: 'internal',
    estimatedPrice: 8.9,
    keywords: ['placa', '4x2', '2 módulos', 'acabamento', 'branca', 'margirius'],
  },
  {
    id: 'tramontina-condulete-aluminio-3-4',
    brand: 'Tramontina',
    line: 'Conduletes',
    ...
    source: 'internal',
    estimatedPrice: 22.0,
    keywords: ['condulete', 'aluminio', '3/4', 'aparente', 'tramontina'],
  },
  {
    id: 'tramontina-canaleta-20x10-branca',
    brand: 'Tramontina',
    line: 'Canaletas',
    category: 'Infraestrutura',
    ...
    source: 'internal',
    estimatedPrice: 7.5,
    keywords: ['canaleta', 'pvc', '20x10', 'branca', 'tramontina'],
  },
  {
    id: 'tramontina-caixa-sobrepor-4x2-branca',
    brand: 'Tramontina',
    line: 'Sobrepor',
    category: 'Infraestrutura',
    ...
    source: 'internal',
    estimatedPrice: 9.8,
    keywords: ['caixa', 'sobrepor', '4x2', 'branca', 'tramontina'],
  },
  {
    id: 'weg-contator-cwb9-220v',
    brand: 'WEG',
    line: 'CWB',
    category: 'Automação e comando',
    subcategory: 'Contator',
    title: 'Contator WEG CWB9 bobina 220V',
    model: 'CWB9',
    unit: 'un',
    ...
    source: 'internal',
    estimatedPrice: 89.0,
    keywords: ['contator', 'cwb9', 'bobina', '220v', 'weg'],
  },
  {
    id: 'weg-rele-termico-rw17-1d6-2d5a',
    brand: 'WEG',
    line: 'RW17',
    category: 'Automação e comando',
    subcategory: 'Relé térmico',
    title: 'Relé térmico WEG RW17 1,6–2,5A',
    model: 'RW17',
    unit: 'un',
    ...
    source: 'internal',
    estimatedPrice: 76.0,
    keywords: ['rele termico', 'rw17', 'motor', 'sobrecarga', 'weg'],
  },
  {
    id: 'weg-disjuntor-motor-mp16-4a',
    brand: 'WEG',
    line: 'MPW',
    category: 'Automação e comando',
    subcategory: 'Disjuntor motor',
    title: 'Disjuntor motor WEG MPW ajuste até 4A',
    unit: 'un',
    ...
    keywords: ['disjuntor motor', 'mpw', 'motor', '4a', 'weg'],
  },
];
