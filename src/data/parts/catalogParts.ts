...
export const catalogParts: CatalogPart[] = [
  ...
  },
  {
    ...
    color: 'Branco',
    application: 'Materiais e insumos recorrentes para execução de serviços.',
    source: 'internal',
    estimatedPrice: 7.5,
  ...
  },
  {
    ...
    line: 'CWB',
    category: 'Materiais',
    subcategory: 'Item de execução',
    title: 'Item técnico Fabricante D CWB9',
    model: 'CWB9',
    unit: 'un',
    description: 'Item de execução para serviços recorrentes.',
    voltage: '220 V',
    application: 'Material de apoio para composição de custos de serviço.',
    source: 'internal',
    estimatedPrice: 89.0,
  ...
  },
  {
    ...
    category: 'Materiais',
    subcategory: 'Item de execução',
    title: 'Item de proteção Fabricante D RW17',
    model: 'RW17',
    unit: 'un',
    description: 'Item de proteção para composição de materiais.',
    current: '1,6–2,5 A',
    application: 'Material recorrente para serviços com custo controlado.',
    source: 'internal',
    estimatedPrice: 76.0,
    keywords: ['proteção', 'rw17', 'materiais', 'custos', 'fabricante-d'],
  },
  {
    id: 'fabricante-d-item-protecao-mp16-4a',
    brand: 'Fabricante D',
    line: 'MPW',
    category: 'Materiais',
    subcategory: 'Item de proteção',
    title: 'Item de proteção Fabricante D MPW ajuste até 4A',
    unit: 'un',
    description: 'Item de proteção para serviços recorrentes.',
    current: 'até 4 A',
    application: 'Material para orçamento e controle de custos.',
    source: 'internal',
    estimatedPrice: 128.0,
    keywords: ['proteção', 'mpw', 'materiais', '4a', 'fabricante-d'],
  },
];
