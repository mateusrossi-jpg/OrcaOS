...
describe('AFERIX PHASE 2.5: HARDENING & CORPORATE VALIDATION TESTS', () => {
  ...
  it('TEST 1: MÚLTIPLOS ORÇAMENTOS CONCORRENTES (Extreme Commercial States)', async () => {
    ...
    const budgets = [
      { id: 'b-h1-1', clientId: 'client-hard-1', siteId: 'site-hard-1', companyId: 'company-test-1', workspaceId: 'workspace-test-1', title: 'Orçamento A', status: BUDGET_STATUS.AUTORIZADO, chargedValue: 1200, attendanceId, items: [], createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
      { id: 'b-h1-2', clientId: 'client-hard-1', siteId: 'site-hard-1', companyId: 'company-test-1', workspaceId: 'workspace-test-1', title: 'Orçamento B', status: BUDGET_STATUS.RECUSADO, chargedValue: 3000, attendanceId, items: [], createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
      { id: 'b-h1-3', clientId: 'client-hard-1', siteId: 'site-hard-1', companyId: 'company-test-1', workspaceId: 'workspace-test-1', title: 'Orçamento C', status: BUDGET_STATUS.RECUSADO, chargedValue: 5000, attendanceId, items: [], createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
      { id: 'b-h1-4', clientId: 'client-hard-1', siteId: 'site-hard-1', companyId: 'company-test-1', workspaceId: 'workspace-test-1', title: 'Orçamento D', status: BUDGET_STATUS.CANCELADO, chargedValue: 8000, attendanceId, items: [], createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
      { id: 'b-h1-5', clientId: 'client-hard-1', siteId: 'site-hard-1', companyId: 'company-test-1', workspaceId: 'workspace-test-1', title: 'Orçamento E', status: BUDGET_STATUS.EM_EXECUCAO, chargedValue: 2800, attendanceId, items: [], createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    ];
