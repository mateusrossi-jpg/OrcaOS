...
* **Catálogo:** Visível apenas via "Settings" que está no App.tsx mas ausente no AppShell bottom nav. **[BUG ABERTO: Menu Catálogo não tem ícone na dock]**
...
* **Configurações/Perfil/Empresa:** "Entrar na Empresa" na tela Pulse, mas as Settings foram retiradas da Dock (`AppShell.tsx`). **[BUG ABERTO: Aba Settings inacessível]**
