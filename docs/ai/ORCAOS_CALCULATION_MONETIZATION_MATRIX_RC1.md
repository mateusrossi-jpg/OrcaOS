...
- O gate central usa a camada `accountPlanStorage`; identidade Google pode alimentar a conta quando `VITE_GOOGLE_CLIENT_ID` estiver configurado, mas pagamento e assinatura real ainda serao conectados depois.
