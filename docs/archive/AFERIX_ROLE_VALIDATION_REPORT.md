...
| Perfil | Shell Carregado | Itens do Menu (Tabs) | Visibilidade EQUIPE | Visibilidade PROPOSTAS | Status |
| :--- | :--- | :--- | :---: | :---: | :--- |
...
3.  **Diferencial Crítico:** A aba `EQUIPE` foi removida, dando lugar à aba `PROPOSTAS` diretamente no menu principal.
