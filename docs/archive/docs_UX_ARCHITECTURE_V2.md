...
*   **Ação no Rodapé:** O *Safe Area Bottom* e o *StickyActionBar* são os motores do app. Tudo que exige decisão do usuário deve estar acessível pelo ergonomia direito.
