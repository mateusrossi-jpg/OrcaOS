...
* **Canary Releases:** Rollout gradual de novas versões (ex: liberar a nova visualização de dock de atendimento para apenas 5% das contas Professional da vertical Climatização).
