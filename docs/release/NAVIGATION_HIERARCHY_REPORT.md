...
### 1. INDEPENDÊNCIA DA DOCK (DOCK PURITY)
...
*   **Ergonomia:** Isto mantém a barra inferior com os 5 itens ideais para a zona do polegar em dispositivos mobile.
...
*   **Foco Técnico:** O Workspace de Operações agora é 100% dedicado à gestão de OSs, Agendamentos e Ativos em campo.
