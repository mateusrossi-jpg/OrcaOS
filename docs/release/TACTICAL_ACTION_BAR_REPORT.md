...
*   **Posicionamento Ergonomicamente Correto:** O sub-menu agora surge imediatamente acima da dock principal ao selecionar "Operações".
...
As opções extras agora estão organizadas horizontalmente para acesso rápido com o polegar:
