...
*   **Mobile-First (Bottom-Sheet):** Em telas pequenas, o modal agora se comporta como uma gaveta (drawer) que sobe da parte inferior. Isso garante que os botões de ação estejam sempre ao alcance do polegar e respeita as **áreas seguras (safe-areas)** do iOS/Android.
