...
- O botão de "Salvar" ou "Confirmar" SEMPRE fica ancorado no fundo da tela em dispositivos móveis, para alcance garantido do polegar, independente de quão longo seja o formulário.
