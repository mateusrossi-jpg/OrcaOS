...
*   **Resposta:** **SIM.**
*   **Evidência:** A aba "PROPOSTAS" agora ocupa a 3ª posição no Dock inferior, sendo visível em qualquer workspace do sistema.

### Teste 2: Funcionalidade do Dock
*   **Uso:** O Dock agora possui 6 itens.
*   **Observação:** A largura mínima de 280px e o `max-width: 90vw` do `OperationalDock` acomodam os 6 itens sem quebra de layout, embora a densidade de toque esteja no limite superior da ergonomia mobile.
